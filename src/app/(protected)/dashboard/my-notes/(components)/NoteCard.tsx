...
export default function NoteCard({
  ...
  return (
    <Card className="w-full  border dark:border-gray-800  hover:border-[#FFD700]/40 hover:shadow-[#FFD700]/10 transition-all duration-200 shadow-md rounded-2xl overflow-hidden">
