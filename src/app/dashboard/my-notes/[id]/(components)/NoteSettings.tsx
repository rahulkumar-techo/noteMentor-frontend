/**
 * NoteSettings Form (Refactored for Array Handling)
 * -----------------------------------------------------------
 * ✅ Fixed issue: sharedWith now correctly parses comma-separated string to array
 * ✅ Keeps same responsive UI and clean logic
 */
